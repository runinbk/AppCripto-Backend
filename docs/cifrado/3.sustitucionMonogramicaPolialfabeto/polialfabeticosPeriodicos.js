...
function cifradoPolialfabéticoPeriódico(texto, claves) {
    ...
    for (let i = 0; i < texto.length; i++) {
        ...
        if (letraOriginal.match(/[A-Za-z]/)) {
            const letraCifrada = cifrarLetra(letraOriginal, claveActual[indiceClave % claveActual.length]);
...
function cifrarLetra(letraOriginal, clave) {
...
module.exports = { cifradoPolialfabéticoPeriódico, descifradoPolialfabéticoPeriódico };
